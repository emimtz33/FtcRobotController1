...
@TeleOp(name = "Mecanum by Emiliano")
public class MecanumDrive extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        while  (opModeIsActive()){
            ...
            FrenteIzquierdo.setPower(((LyAjustada+LxAjustada+rx)/max)*currentPower); //positivo hacia enfrente
            AtrasIzquierdo.setPower(((LyAjustada-LxAjustada+rx)/max)*currentPower); //invertimos lx para que sea igual que FrenteIzquierdo
            FrenteDerecho.setPower(((LyAjustada-LxAjustada-rx)/max)*currentPower); //opuesto a FrenteIzquierdo
            AtrasDerecho.setPower(((LyAjustada+LxAjustada-rx)/max)*currentPower); //opuesto a AtrasIzquierdo
        }
    }
}
